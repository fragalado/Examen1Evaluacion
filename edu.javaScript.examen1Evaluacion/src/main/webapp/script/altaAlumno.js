...
// Comprobamos que edad sea un numero y que sea mayor que cero
while (isNaN(edad) || edad < 1) {
	if(isNaN(edad))
		edad = Number(prompt("**Error: El valor tiene que ser un numero**\nIntroduzca su edad:"));
	if(edad < 1)
		edad = Number(prompt("**Error: El valor tiene que ser mayor que 0**\nIntroduzca su edad:"));
}
...
apellidos = apellidos.split(" "); // Separamos los apellidos en dos, hacemos un array con dos posiciones
									// teniendo en cuenta que se introducen asi: "Gallego Dorado"
...
document.write("<br>Edad: " + edad + " a&ntilde;os.");
